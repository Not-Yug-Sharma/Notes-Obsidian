...
<ol>
	...
	<li>GIT: <a href="https://git-scm.com/install/">Use this link and download the variant depending on your OS</a><br>Or you can use the following command on windows CMD: winget install --id Git.Git -e --source winget <br> This for Linux<i>: </li>
